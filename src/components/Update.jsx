...
function Update() {
    ...
    useEffect(()=>{
        Axios.get("http://127.0.0.1:3000/read/"+id).then((response)=>{
    ...
    const updateList=(e)=>{
        e.preventDefault()
        Axios.put("http://127.0.0.1:3000/update/"+id,newList)
        .then((res)=>{
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            onChange={(e)=>{setNewlist({...newList,npassword:e.target.value})}}
                        />
                    </div>
                    <div class="form-group">
